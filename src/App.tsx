...
import { onForegroundMessage } from './utils/foregroundMessageListner';
import ToastifyNotification from './component/ToastNotification';
...
const App: React.FC = () => {
  ...
  return (
    <div className="app">
      ...
      <button
        className={`${!loading ? 'btn-primary bg-[#1a75ed] text-white' : 'cursor-not-allowed  bg-gray-500 text-gray-300 btn-primary'}`}
